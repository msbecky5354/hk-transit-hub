...
window.MTR_BUS_DICT = {
    "ROUTES": {
        "K74": { dest_tc: "凹頭 (循環線)", dest_en: "Au Tau (Circular)" },
        "K75P": { dest_tc: "洪水橋 (循環線)", dest_en: "Hung Shui Kiu (Circular)" },
        "K68": { dest_tc: "元朗公園 (循環線)", dest_en: "Yuen Long Park (Circular)" },
        "K66": { dest_tc: "大棠黃泥墩村", dest_en: "Tai Tong" }
    },
    "STOPS": {
        "K75P-0010": { tc: "洪水橋巴士廠", en: "Hung Shui Kiu Bus Depot" },
        "K75P-0020": { tc: "洪福邨", en: "Hung Fuk Estate" },
        "K75P-0030": { tc: "石埗村", en: "Shek Po Tsuen" },
        "K75P-0040": { tc: "天盛苑", en: "Tin Shing Court" },
        "K74-D010": { tc: "天水圍市中心", en: "Tin Shui Wai Town Centre" },
        "K74-D060": { tc: "天水圍站", en: "Tin Shui Wai Station" },
        "K74-D080": { tc: "朗屏邨總站", en: "Long Ping Estate Bus Terminus" },
        "K74-D110": { tc: "凹頭", en: "Au Tau" }
    }
};
